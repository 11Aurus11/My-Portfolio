            ...
            <div className="container">
                <div className="grid">
                    <div className="section">
                        <h3>Моё портфолио</h3>
                        <p>Создаю цифровые решения, которые помогают бизнесу расти и развиваться.</p>
                    </div>
                    <div className="section">
                    ...
                    <div className="section">
                        ...
                        <div className="socialLinks">
                            <a href="#" aria-label="Telegram">
                                <svg width="800px" height="800px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000" className="bi bi-telegram">
                ...
                <div className="bottom">
                    {/* <p>&copy; {currentYear} Creative Studio. Все права защищены.</p> */}
                </div>
            </div>
        </footer>
    )
